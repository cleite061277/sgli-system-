...
def admin_index(request):
    ...
    # Adicionar URL do dashboard financeiro no contexto
    try:
        dashboard_financeiro_url = reverse('dashboard_financeiro')
    except Exception:
        dashboard_financeiro_url = None
    ...
    context = {
        ...
        'dashboard_financeiro_url': dashboard_financeiro_url,  # ← ADICIONADO
