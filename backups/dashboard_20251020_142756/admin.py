...
class LocacaoAdmin(admin.ModelAdmin):
    ...
    def change_view(self, request, object_id, form_url='', extra_context=None):
        """Adiciona botões 'Gerar Contrato' na view de edição."""
        extra_context = extra_context or {}
        extra_context['show_gerar_contrato'] = True
        extra_context['contrato_docx_url'] = f'/locacao/{object_id}/gerar-contrato/docx/'
        extra_context['contrato_pdf_url'] = f'/locacao/{object_id}/gerar-contrato/pdf/'
